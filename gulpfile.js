...
gulp.task('distribute', ['vulcanize', 'javascript'], _clean);



// gulp.task('polybuild', ['less'], function () {

//     return gulp.src('src/carbo-inspector.html')
...
//             gzip: true
//         }))
//         .pipe(gulp.dest('carbo-inspector.html'));
